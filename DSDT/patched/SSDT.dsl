...
DefinitionBlock ("ssdt.aml", "SSDT", 1, "APPLE ", "CpuPm", 0x00021500)
{
    ...
    Scope (\_PR_.CPU0)
    {
        ...
        Name (APSS, Package (0x1C)
        {
            ...
            Package (0x06) { 0x044C, 0x003067, 0x0A, 0x0A, 0x0B00, 0x0B00 },
            Package (0x06) { 0x03E8, 0x002B75, 0x0A, 0x0A, 0x0A00, 0x0A00 },
            /* Low Frequency Mode */
            Package (0x06) { 0x0384, 0x00269F, 0x0A, 0x0A, 0x0900, 0x0900 },
