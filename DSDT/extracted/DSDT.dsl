 ...
 *
 * Disassembly of DSDT.aml, Sun Feb 19 21:29:19 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001109F (69791)
 ...
 */
DefinitionBlock ("", "DSDT", 1, "Apple ", "TP-G7   ", 0x00002660)
{
    ...
    Scope (\_SB)
    {
        ...
        Scope (\)
        {
            ...
            Name (PLD0, Buffer (0x10)
            {
                ...
                /* 0008 */  0x69, 0x11, 0x80, 0x00, 0x03, 0x00, 0x00, 0x00 
            })
            ...
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x11, 0x10, 0x00, 0x01, 0x03, 0x00, 0x00, 0x00 
            })
            ...
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x69, 0x12, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00 
            })
            Name (UP10, Package (0x04)
            {
                0xFF, 
                0xFF, 
                0x00, 
            ...
            Name (PL10, Buffer (0x10)
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x30, 0x1C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 
            })
            Name (UP11, Package (0x04)
            {
                0xFF, 
                0xFF, 
                0x00, 
            ...
            Name (PL11, Buffer (0x10)
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x30, 0x1C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 
            })
            Name (UP12, Package (0x04)
            {
                0xFF, 
                0xFF, 
                0x00, 
            ...
            Name (PL12, Buffer (0x10)
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x30, 0x1C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 
            })
            Name (UP13, Package (0x04)
            {
                0xFF, 
                0xFF, 
                0x00, 
                ...
                If (LEqual (Arg0, ToUUID ("33db4d5b-1ff7-401c-9657-7441c03dd766") /* PCI Host Bridge Device */))
                {
                    ...
                    If (LNot (And (CDW1, 0x01)))
                    {
                        If (And (CTRL, 0x01))
                        {
                            ...
                            Store (0x00, \_SB.PCI0.EXP6.HPCE)
                            Store (0x01, \_SB.PCI0.EXP6.HPCS)
                            Store (0x01, \_SB.PCI0.EXP6.PDC)
                            Store (0x00, \_SB.PCI0.EXP7.HPCE)
                            Store (0x01, \_SB.PCI0.EXP7.HPCS)
                            Store (0x01, \_SB.PCI0.EXP7.PDC)
                            Store (0x00, \_SB.PCI0.EXP8.HPCE)
                            Store (0x01, \_SB.PCI0.EXP8.HPCS)
                            Store (0x01, \_SB.PCI0.EXP8.PDC)
                            Store (0x01, \NHPS)
                        }
                        ...
                        If (And (CTRL, 0x04))
                        {
                            ...
                            If (\_SB.PCI0.EXP8.PMCE)
                            {
                                Store (0x00, \_SB.PCI0.EXP8.PMCE)
                                Store (0x01, \_SB.PCI0.EXP8.PMCS)
                            }
                ...
                Device (VID)
                {
                    ...
                    Method (_PS0, 0, NotSerialized)  // _PS0: Power State 0
                    {
                        If (ISOP ())
                        {
                            ...
                            ElseIf (LNotEqual (VSID, 0x220017AA))
                            {
                                \VHYB (0x04, 0x00)
                            }
    ...
    Method (\_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (Local0)
        {
            ...
            If (LNotEqual (Arg0, 0x05))
            {
                ...
                Store (\_SB.PCI0.EXP7.PDS, \_SB.PCI0.EXP7.PDSF)
                Store (\_SB.PCI0.EXP8.PDS, \_SB.PCI0.EXP8.PDSF)
            }
    ...
    Method (\_WAK, 1, NotSerialized)  // _WAK: Wake
    {
        ...
        If (XOr (\_SB.PCI0.EXP7.PDS, \_SB.PCI0.EXP7.PDSF))
        {
            Store (\_SB.PCI0.EXP7.PDS, \_SB.PCI0.EXP7.PDSF)
            Notify (\_SB.PCI0.EXP7, 0x00)
        }

        If (XOr (\_SB.PCI0.EXP8.PDS, \_SB.PCI0.EXP8.PDSF))
        {
            Store (\_SB.PCI0.EXP8.PDS, \_SB.PCI0.EXP8.PDSF)
            Notify (\_SB.PCI0.EXP8, 0x00)
        }
    ...
    Scope (\_GPE)
    {
        ...
        Method (_L01, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            If (\_SB.PCI0.EXP7.HPCS)
            {
                Sleep (0x64)
                Store (0x01, \_SB.PCI0.EXP7.HPCS)
                If (\_SB.PCI0.EXP7.PDC)
                {
                    Store (0x01, \_SB.PCI0.EXP7.PDC)
                    Store (\_SB.PCI0.EXP7.PDS, \_SB.PCI0.EXP7.PDSF)
                    Notify (\_SB.PCI0.EXP7, 0x00)
            ...
            If (\_SB.PCI0.EXP8.HPCS)
            {
                Sleep (0x64)
                Store (0x01, \_SB.PCI0.EXP8.HPCS)
                If (\_SB.PCI0.EXP8.PDC)
                {
                    Store (0x01, \_SB.PCI0.EXP8.PDC)
                    Store (\_SB.PCI0.EXP8.PDS, \_SB.PCI0.EXP8.PDSF)
                    Notify (\_SB.PCI0.EXP8, 0x00)
    ...
    Method (TBTS, 0, NotSerialized)
    {
        SMI (0x00, 0x09, 0x00, 0x00, 0x00)
    }
